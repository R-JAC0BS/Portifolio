...
export default function Tecnologias() {
    ...
    return (
        <div className="h-full justify-center flex flex-col items-center" id="tecnologias">
            <h2 className="text-3xl font-bold mt-10 mb-2">Tecnologias</h2>
            <div className="flex z-0 w-full sm:w-11/12 md:w-10/12 justify-center items-start flex-wrap gap-8 px-8 py-10">
                {minhasTecnologias && Object.values(minhasTecnologias).map((group, i) => (
                    <div key={i} className="relative z-10 rounded-2xl border border-gray-200 p-8 flex flex-col gap-4 w-72 shadow-[0_6px_10px_rgba(0,0,0,0.1)]" style={{ backgroundColor: 'var(--container-color)' }}>
